<<<<<<< HEAD
angular.module('xn.first.service', []).factory('FirstService', [
  '$q',
  'Restangular',
  '$window',
  'Storage',
  ...
  function(
    ...
    return {
      ...
      getShopDetailsHeader: function(id) {
        var all = XnRestAngular.allUrl(
          '/Goods/getDetailGoodsInfo?' + 'goods_id=' + id
        )
        return all.get('')
      },
      //商品详情的属性
      getShopDetailsAtt: function(id) {
        var all = XnRestAngular.allUrl(
          '/Goods/getGoodsAttrName?' + 'goods_id=' + id
        )
        return all.get('')
      },
      //根据商品的属性获得具体的商品
      ...
      getTrainDetails: function(id) {
        var all = XnRestAngular.allUrl(
          '/Training/getTrainDetail?train_id=' + id
        )
        return all.get('')
      },
      //企业动态
      ...
      getConditionMenu: function(id) {
        var all = XnRestAngular.allUrl(
          '/Dynamic/getDynamicByCatId?' + 'cat_id=' + id
        )
        return all.get('')
      },
      //企业动态全部分类的接口
      ...
      getConditionDetails: function(id) {
        var all = XnRestAngular.allUrl(
          '/Dynamic/getPassageDetailContent?' + 'dyn_id=' + id
        )
        return all.get('')
      },
      //添加地址
      ...
      setDefultAddress: function(id) {
        var all = XnRestAngular.allUrl(
          '/Consigne/setDefultAddress?cgn_id=' + id
        )
        return all.get('')
      },
      //删除地址
      ...
      WeiPayNotifyUrl: function(order_numbers) {
        var all = XnRestAngular.allUrl('/Order/WeiPayclientNotifyUrl')
        return all.post({ order_numbers: order_numbers })
      },
      //获取反馈列表
